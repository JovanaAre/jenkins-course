...
pipeline {
    ...
    parameters {
    string defaultValue: 'pipeline.zip', description: 'This is description.', name: 'JOVANA'
    ...
    stages {
        stage('Download'){
            steps {
                cleanWs()
                withCredentials([usernamePassword(credentialsId: '633fa779-ace9-47f6-87fd-00b021475820', passwordVariable: 'password', usernameVariable: 'username')]) {
            ...
            steps {
                ...
                rtUpload(
                    ...
                    spec: """ {
                          ...
                          {
                            "pattern": "${JOVANA}.zip",
                            "target": "generic-local/jovana/${env.BUILD_ID}/${JOVANA}.zip"
                          }
                        ]
                     }"""
                )
